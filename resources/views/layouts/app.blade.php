...
<div id="body_container">
    <header class="flex-row padding-1rem z-depth-1 nav-padding">
            <!-- Voir la navigation !!! -->
        <a href="@if(Session::has('user') && session('user')->admin == 1) {{ route('importerBouteille') }}@else {{ route('cellier') }} @endif" class="logo-lien margin-right-1"><img class="logo" src="{{asset('assets/logo/vino-logo-v2.svg')}}" alt="logo InVino"></a>
